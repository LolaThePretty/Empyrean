...
const LevelScript level_castle_inside_entry[] = {
	...
	AREA(1, castle_inside_area_1),
		...
		WARP_NODE(0x62, LEVEL_ENDING, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_HUB_ELEVATOR, 3693, -150, 3431, 0, 0, 0, 0x00670000, bhvHubElevator),
		OBJECT(MODEL_NONE, 0, -7383, 0, 0, 0, 0, 0x00000000, bhv1Up),
		OBJECT(MODEL_RAINBOW_MAGIC_ORB, -1731, -50, 2317, 0, 0, 0, 0x00690000, bhvRainbowMagicOrb),
		OBJECT(MODEL_SHIP_WRECK, -4423, 210, -722, 0, 0, 0, 0x00680000, bhvShipWreck),
		OBJECT(MODEL_NONE, 3715, 139, 2594, 0, 3, 0, 0x00050000, bhvLaunchDeathWarp),
		OBJECT(MODEL_NONE, 3715, 139, 2594, 0, 3, 0, 0x00120000, bhvLaunchStarCollectWarp),
		OBJECT(MODEL_NONE, 0, 700, 0, 0, 0, 0, 0x001F0000, bhvWarp),
		OBJECT(MODEL_NONE, 0, 200, 0, 0, 0, 0, 0x00130000, bhvDeathWarp),
		OBJECT(MODEL_NONE, 0, 200, 0, 0, 0, 0, 0x000A0000, bhvAirborneWarp),
		OBJECT(MODEL_NONE, 3723, -43, 2792, 0, 0, 0, 0x00040000, bhvWarp),
		OBJECT(MODEL_NONE, -3339, -100, 387, 0, 0, 0, 0x00620000, bhvWarp),
