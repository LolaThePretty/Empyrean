Lights1 wf_dl_Ground_lights = gdSPDefLights1(
	0x7F, 0x7F, 0x7F,
	0xFE, 0xFE, 0xFE, 0x28, 0x28, 0x28);

Lights1 wf_dl_Cube_lights = gdSPDefLights1(
	0x76, 0x0, 0x7F,
	0xEC, 0x0, 0xFE, 0x28, 0x28, 0x28);

Gfx wf_dl_Planks_rgba16_aligner[] = {gsSPEndDisplayList()};
u8 wf_dl_Planks_rgba16[] = {
...
Vtx wf_dl_Ground_mesh_layer_1_vtx_0[4] = {
...
Gfx wf_dl_Ground_mesh_layer_1_tri_0[] = {
	gsSPVertex(wf_dl_Ground_mesh_layer_1_vtx_0 + 0, 4, 0),
	gsSP1Triangle(0, 1, 2, 0),
	gsSP1Triangle(0, 2, 3, 0),
	gsSPEndDisplayList(),
};

Vtx wf_dl_Ground_mesh_layer_1_vtx_1[72] = {
...
Gfx wf_dl_Ground_mesh_layer_1_tri_1[] = {
	gsSPVertex(wf_dl_Ground_mesh_layer_1_vtx_1 + 0, 16, 0),
	gsSP1Triangle(0, 1, 2, 0),
	gsSP1Triangle(0, 2, 3, 0),
	...
	gsSPVertex(wf_dl_Ground_mesh_layer_1_vtx_1 + 16, 16, 0),
	gsSP1Triangle(0, 1, 2, 0),
	gsSP1Triangle(0, 2, 3, 0),
	gsSP1Triangle(4, 5, 6, 0),
	gsSP1Triangle(4, 6, 7, 0),
	...
	gsSP1Triangle(12, 13, 14, 0),
	gsSP1Triangle(12, 14, 15, 0),
	gsSPVertex(wf_dl_Ground_mesh_layer_1_vtx_1 + 32, 16, 0),
	gsSP1Triangle(0, 1, 2, 0),
	gsSP1Triangle(0, 2, 3, 0),
	gsSP1Triangle(4, 5, 6, 0),
	gsSP1Triangle(4, 6, 7, 0),
	...
	gsSP1Triangle(12, 13, 14, 0),
	gsSP1Triangle(12, 14, 15, 0),
	gsSPVertex(wf_dl_Ground_mesh_layer_1_vtx_1 + 48, 16, 0),
	gsSP1Triangle(0, 1, 2, 0),
	gsSP1Triangle(0, 2, 3, 0),
	gsSP1Triangle(4, 5, 6, 0),
	gsSP1Triangle(4, 6, 7, 0),
	...
	gsSP1Triangle(12, 13, 14, 0),
	gsSP1Triangle(12, 14, 15, 0),
	gsSPVertex(wf_dl_Ground_mesh_layer_1_vtx_1 + 64, 8, 0),
	gsSP1Triangle(0, 1, 2, 0),
	gsSP1Triangle(0, 2, 3, 0),
	gsSP1Triangle(4, 5, 6, 0),
	gsSP1Triangle(4, 6, 7, 0),
...
Gfx mat_wf_dl_Ground[] = {
	...
	gsDPTileSync(),
	gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b_LOAD_BLOCK, 1, wf_dl_Planks_rgba16),
...
Gfx mat_wf_dl_Cube[] = {
	...
	gsSPTexture(65535, 65535, 0, 0, 1),
	gsSPSetLights1(wf_dl_Cube_lights),
	gsSPEndDisplayList(),
};
...
Gfx wf_dl_Ground_mesh_layer_1[] = {
	...
	gsSPDisplayList(mat_wf_dl_Cube),
