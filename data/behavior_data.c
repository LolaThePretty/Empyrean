...
// Tiny wind particles that provide aesthetics to the strong winds generated by the Snowman.
...
// Strong wind particles generated by the Snowman that blow Mario back and knock his cap off.
...
const BehaviorScript bhvHubElevator[] = {
    BEGIN(OBJ_LIST_SURFACE),
...
const BehaviorScript bhvShipWreck[] = {
    BEGIN(OBJ_LIST_SURFACE),
    LOAD_COLLISION_DATA(ship_wreck_collision),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_UCODE_LARGE)),
    SET_FLOAT(oDrawingDistance, 20000),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_ship_wreck_loop),
        CALL_NATIVE(load_object_collision_model),
    END_LOOP(),
};
...
const BehaviorScript bhvRainbowMagicPlatform[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_COLLISION_DATA(rainbow_magic_platform_collision),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    SET_FLOAT(oCollisionDistance, 3000),
    SET_HOME(),
